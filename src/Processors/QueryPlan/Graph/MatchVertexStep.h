...
class MatchVertexStep final : public SourceStepWithFilterBase {
 public:
  MatchVertexStep(GraphStoragePtr storage_, String variable_, Names referenced_columns_, ContextPtr context_);
 ...
 private:
  static SharedHeader makeHeader(const GraphStoragePtr &storage, const String &variable, const Names &referenced_columns);
